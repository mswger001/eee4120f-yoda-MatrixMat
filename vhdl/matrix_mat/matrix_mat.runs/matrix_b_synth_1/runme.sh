...
HD_PWD='C:/Users/idiyp/Downloads/EEE4120F-master/EEE4120F-master/Prac3/Prac3_2_Code/matrix_mat/matrix_mat.runs/matrix_b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_b.tcl
