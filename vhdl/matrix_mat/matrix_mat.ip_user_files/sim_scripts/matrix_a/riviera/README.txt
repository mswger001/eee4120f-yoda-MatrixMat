...
#
# Generated by export_simulation on Fri May 19 00:03:21 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './matrix_a.sh' script.

./matrix_a.sh -reset_run
...
./matrix_a.sh -noclean_files

For more information on the script, please type './matrix_a.sh -help'.
